...
const BranchRecordEdit = ({selectedBranch, updateBranchHandler, deleteBranch}) => {
    const [formData, setFormData] = useState({
        branchName: "",
        status: "Select", // Initialize with a default value
      });
    ...
    <div className="modal-box">
      <div className="card bg-white border">
        <div className="card-header bg-green-400 w-full flex p-2">
          ...
          <h1 className="py-2 px-3 mx-auto font-bold">Edit Branch Record</h1>
        </div>
        <div className="card-body">
          ...
          <div className="flex text-black mt-2">
            ...
            <form method="dialog">
              <button className="btn bg-red-600 hover:bg-red-800 hover:text-white" onClick={() => deleteBranch()}>
                Delete
              </button>
            </form>
          </div>
...
export default BranchRecordEdit